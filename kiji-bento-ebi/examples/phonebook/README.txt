...
target/kiji-phonebook-1.1.5-release/ directory.


RUNNING:

  To run this example, you will need to configure Kiji 1.1.5,
...
with:
  ...
  $ kiji jar lib/kiji-phonebook-1.1.5.jar \
...
be placed somewhere in your hdfs.
  ...
  $ kiji jar kiji-phonebook-1.1.5.jar \
